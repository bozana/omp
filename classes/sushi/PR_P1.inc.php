...
{
    public array $metricTypes = ['Total_Item_Requests', 'Unique_Item_Requests', 'Unique_Title_Requests'];
    ...
    public function setFilters(array $filters)
    {
        ...
        $predefinedFilters = [
            ['Name' => 'Metric_Type', 'Value' => 'Total_Item_Requests|Unique_Item_Requests|Unique_Title_Requests'],
