...
<div class="bookInfo">
	...
	<div id="bookInfoTabs">
		<ul>
			...
			{* cemog tabs: reviews and press *}
			<li><a href="#reviewsTab">{translate key="plugins.generic.cemog.book.Reviews"}</a></li>
			<li><a href="#pressTab">{translate key="plugins.generic.cemog.book.pressMaterial"}</a></li>
			{* content tab removed *}
